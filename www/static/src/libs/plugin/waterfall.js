...
;(function( $, window, document, undefined ) {
    ...
    Waterfall.prototype = {
        ...
        _initContainer: function() {
            ...
            this.$element.after('<div id="' + prefix + '-loading" class="waterfall-loading">' +options.loadingMsg+ '</div><div class="waterfall-message" id="' + prefix + '-message" style="text-align:center;color:#999;"></div>');
