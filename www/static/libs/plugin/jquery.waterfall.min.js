...
(function (t, i, e, s) {
    ...
    n.prototype = {constructor: n, _debug: function () {
        ...
        t("body").css({"overflow-y": "scroll", "overflow-x": "hidden"}), this.$element.css({"overflow-x":"hidden","overflow-y":"hidden"}),this.$element.css(this.options.containerStyle).addClass(e + "-container"), this.$element.after('<div id="' + e + '-loading">' + i.loadingMsg + '</div><div id="' + e + '-message" style="text-align:center;color:#999;"></div>'), this.$loading = t("#" + e + "-loading"), this.$message = t("#" + e + "-message")
        ...
        s = o.hasClass(a.prefix + "-item-fixed-left") ? 0 : o.hasClass(a.prefix + "-item-fixed-right") ? c > 1 ? c - 1 : 0 : g, n = {left: (r + l) * s + e, top: A[s]}, this.styleQueue.push({$el: o, style: n}), A[s] += o.outerHeight() + h
    }, prepend: function (t, i) {
        this.$element.prepend(t), this.reLayout(i)
    }, append: function (t, i) {
        this.$element.append(t), this.reLayout(i)
        ...
        var e, n = this, o = this.options, a = o.maxPage, r = o.state.curPage++, l = o.path, h = o.dataType, A = o.params, c = o.headers;
        return a !== s && r > a ? (o.state.isBeyondMaxPage = !0, o.callbacks.loadingFinished(this.$loading, o.state.isBeyondMaxPage), s) : (e = "function" == typeof l ? l(r) : l.join(r), this._debug("heading into ajax", e + t.param(A)), o.callbacks.loadingStart(this.$loading), o.state.isDuringAjax = !0, o.state.isProcessingData = !0, t.ajax({url: e, data: A, headers: c, dataType: h, success: function (t) {
        ...
        var t = this.options, i = Math.min.apply({}, this.colHeightArray), e = o.scrollTop() + o.height()-10 - this.$element.offset().top - i;
    ...
    t.fn.imagesLoaded = function (s) {
        ...
        function a(i, s) {
            i.src !== e && -1 === t.inArray(i, c) && (c.push(i), s ? g.push(i) : u.push(i), t.data(i, "imagesLoaded", {isBroken: s, src: i.src}), h && l.notifyWith(t(i), [s, A, t(u), t(g)]), A.length === c.length && (setTimeout(n), A.unbind(".imagesLoaded", o)))
        }
